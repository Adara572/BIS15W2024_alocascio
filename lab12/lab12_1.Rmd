...
deserts %>% 
  ...
  geom_line()+
  geom_point(shape=5)+ # you can experement w shapes
...
homerange %>% 
  ggplot(aes(x = log10.mass)) +
  geom_histogram(color = "salmon2", fill = "peachpuff", bins=10)+
  labs(title = "Distribution of Body Mass")
```
...
homerange %>% 
  ...
  geom_histogram(color = "lavenderblush4", fill = "lavenderblush3", alpha=0.3)+ #we can adjust the number of bins with the bins argument
...
homerange %>% 
  ggplot(aes(x = log10.hra)) +
  geom_density(color = "lavenderblush4", fill = "lavenderblush3", alpha=0.3)+ #we can adjust the number of bins with the bins argument
  labs(title = "Distribution of Homerange")
```
...
homerange %>% 
  ggplot(aes(x=log10.hra)) +
  geom_histogram(aes(y = after_stat(density)), fill = "lavenderblush3", alpha = 0.4, color = "black")+
  geom_density(color = "violetred4")+
  labs(title = "Distribution of Homerange")
```
