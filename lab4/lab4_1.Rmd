...
```{r}
fish_subsets <- select(fish, "fish_id", "length")
```
...
```{r}
mammals_new <- rename(mammals, genus="Genus", wean_mass="wean mass", max_life="max. life", litter_size="litter size", litter_per_year="litters/year")
```
...
```{r}
clean_names(mammals)#super handy
```
